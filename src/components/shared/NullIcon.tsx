const NullIcon: React.FC<{ size?: "SMALL" | "REGULAR" | "LARGE" }> = ({
  ...
  if (size === "LARGE") {
    return (
      <div className="flex flex-row items-center min-w-[1.21rem] max-w-[1.21rem] justify-between px-0.5 group">
        <div className="flex flex-col items-center min-h-[1.21rem] max-h-[1.21rem] justify-between py-0.5">
          <div className="bg-[#969696] group-hover:bg-white h-[0.16rem] w-[0.16rem] rounded-full" />
          <div className="bg-[#969696] group-hover:bg-white h-[0.16rem] w-[0.16rem] rounded-full" />
        </div>
        <div className="flex flex-col items-center min-h-[1.21rem] max-h-[1.21rem] justify-between py-0.5">
          <div className="bg-[#969696] group-hover:bg-white h-[0.16rem] w-[0.16rem] rounded-full" />
